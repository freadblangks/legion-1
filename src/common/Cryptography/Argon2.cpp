...
#include "Argon2.h"
//#include "Argon2.cpp"
#include "../../../dep/argon2/argon2/argon2.c"
...
{
    char buf[Argon2::Argon2::ENCODED_HASH_LEN];
    std::vector<uint8> saltBytes = salt.ToByteVector();
    int status = argon2id_hash_encoded(
        nIterations,
        kibMemoryCost,
        Argon2::Argon2::Argon2::Argon2::PARALLELISM,
        password.c_str(), password.length(),
        saltBytes.data(), saltBytes.size(),
        Argon2::Argon2::HASH_LEN, buf, Argon2::Argon2::ENCODED_HASH_LEN
    );
